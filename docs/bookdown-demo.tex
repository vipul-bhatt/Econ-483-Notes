...
\protect\hypertarget{def:unnamed-chunk-4}{}{\label{def:unnamed-chunk-4} }Let
...
\BeginKnitrBlock{theorem}
\protect\hypertarget{thm:unnamed-chunk-8}{}{\label{thm:unnamed-chunk-8} }The
...
\BeginKnitrBlock{definition}
\protect\hypertarget{def:unnamed-chunk-9}{}{\label{def:unnamed-chunk-9} }An
...
## Residuals:
##       Min        1Q    Median        3Q       Max 
## -0.067605 -0.009501 -0.000556  0.010035  0.123447 
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)    
## (Intercept)  0.010483   0.005335   1.965   0.0499 *  
## z.lag.1     -0.008268   0.004336  -1.907   0.0570 .  
## z.diff.lag   0.280567   0.040184   6.982 8.12e-12 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 0.01715 on 570 degrees of freedom
## Multiple R-squared:  0.08262,    Adjusted R-squared:  0.0794 
## F-statistic: 25.67 on 2 and 570 DF,  p-value: 2.123e-11
## 
## 
## Value of test-statistic is: -1.907 1.9753 
## 
## Critical values for test statistics: 
##       1pct  5pct 10pct
## tau2 -3.43 -2.86 -2.57
...
## Residuals:
##       Min        1Q    Median        3Q       Max 
## -0.067623 -0.009419 -0.000493  0.009996  0.123355 
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)    
## (Intercept)  1.048e-02  5.340e-03   1.962   0.0502 .  
## z.lag.1     -8.371e-03  4.456e-03  -1.878   0.0608 .  
## tt           4.519e-07  4.453e-06   0.101   0.9192    
## z.diff.lag   2.807e-01  4.024e-02   6.976 8.48e-12 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 0.01717 on 569 degrees of freedom
## Multiple R-squared:  0.08263,    Adjusted R-squared:  0.0778 
## F-statistic: 17.08 on 3 and 569 DF,  p-value: 1.231e-10
## 
## 
## Value of test-statistic is: -1.8784 1.318 1.8203 
## 
## Critical values for test statistics: 
##       1pct  5pct 10pct
## tau3 -3.96 -3.41 -3.12
...
Focusing on the volatility, the plot of squared returns and its ACF
...
\hline
  &  Estimate &  Std. Error &  t value & Pr(>|t|)\\
\hline
mu & 0.065 & 0.014 & 4.589 & 0\\
\hline
omega & 0.026 & 0.004 & 6.421 & 0\\
\hline
alpha1 & 0.129 & 0.013 & 9.708 & 0\\
\hline
beta1 & 0.852 & 0.014 & 62.797 & 0\\
\hline
\end{tabular}
\end{table}
...
\hline
  &  Estimate &  Std. Error &  t value & Pr(>|t|)\\
\hline
mu & 0.027 & 0.014 & 1.890 & 0.059\\
\hline
omega & 0.027 & 0.003 & 7.756 & 0.000\\
\hline
alpha1 & 0.000 & 0.013 & 0.000 & 1.000\\
\hline
beta1 & 0.864 & 0.013 & 64.488 & 0.000\\
\hline
gamma1 & 0.221 & 0.024 & 9.023 & 0.000\\
\hline
\end{tabular}
\end{table}
...
\hline
  &  Estimate &  Std. Error &  t value & Pr(>|t|)\\
\hline
mu & 0.030 & 0.011 & 2.710 & 0.007\\
\hline
omega & 0.000 & 0.003 & 0.036 & 0.971\\
\hline
alpha1 & -0.178 & 0.014 & -12.971 & 0.000\\
\hline
beta1 & 0.969 & 0.004 & 263.809 & 0.000\\
\hline
gamma1 & 0.160 & 0.015 & 10.779 & 0.000\\
\hline
\end{tabular}
\end{table}
...
\hline
Unconditional Variance & 1.346 & 1.056 & 1.004\\
\hline
Half-life & 35.701 & 26.739 & 21.661\\
\hline
\end{tabular}
\end{table}
