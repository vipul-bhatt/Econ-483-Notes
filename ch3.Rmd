...
3. Cycle: denoted by $C_t$ are *non-periodic* are fluctuations in that they occur regularly but over periods that are not fixed in duration.
...
retail=read.csv("/Users/home-mac/Documents/Econ-483-Notes/datafiles/retail.csv")

# create time series objects for data 
y1=ts(retail$y, start=c(1992,1), end=c(2018,6), frequency=12)
