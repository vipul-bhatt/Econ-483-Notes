...
y2=ts(retail$y, start=c(1992,1), end=c(2018,6), frequency=12)
...
To implement this test, we estimate equation \@ref(eq:bg) by replacing the error term with the OLS residuals. The LM test statistic is given by:
