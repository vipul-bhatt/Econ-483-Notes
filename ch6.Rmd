...
The root that satsifies the above equation is:
\[ L^*=\frac{1}{\phi_1}\]
...
A mathematical simplification is to work with natural logs of the likelihood function, which assuming indpendently distributed random sample, gives us:
...
Furthermore, as the order of AR increases, the joint density function we need to estimate becomes even more compplicated. 
...
Similaryl, the 2-period ahead forecast is given by:
